...
/**
 * @brief       Returns shape's x 
 *
 * @detailed    Accesses the private attribute ref_x and returns it for the
 *              user
 * 
...
/**
 * @brief       Returns shape's y 
 *
 * @detailed    Accesses the private attribute ref_y and returns it for the
 *              user
 * 
